...
export async function createLead(
    ...
    try {
        ...
        await createNotification({
            ...
            message: `${result.data.name} submitted a lead for ${result.data.service || "general inquiry"}.`,
            type: "success",
...
export async function updateLeadStatus(formData: FormData) {
    ...
    await createNotification({
        ...
        message: `${currentLead.name} moved from ${currentLead.status} to ${result.data.status}.`,
        type: "info",
        targetUrl: `/crm/leads/${result.data.leadId}`,
        actorId: actor.id,
    });
