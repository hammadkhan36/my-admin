...
const menuGroups: { label: string; items: MenuItem[] }[] = [
  {
    label: "Overview",
    items: [
      { title: "Dashboard", url: "/dashboard", icon: LayoutDashboardIcon, featureKey: "dashboard" },
    ],
  },
  {
    label: "CRM",
  ...
  },
  {
    label: "APPOINTMENTS",
    items: [
      { title: "Appointments", url: "/appointments", icon: CalendarDays, featureKey: "appointments" },
      { title: "Calendar", url: "/appointments/calendar", icon: CalendarCheck, featureKey: "calendar" },
      { title: "Services", url: "/appointments/services", icon: Scissors, featureKey: "services" },
      { title: "Availability", url: "/appointments/availability", icon: ClockIcon, featureKey: "appointments" },
    ],
  },
  {
    label: "Marketing",
    items: [
      { title: "Campaigns", url: "/marketing/campaigns", icon: MegaphoneIcon, featureKey: "campaigns" },
      { title: "Offers", url: "/marketing/offers", icon: TagIcon, featureKey: "offers" },
      { title: "Coupons", url: "/marketing/coupons", icon: TicketIcon, featureKey: "coupons" },
      { title: "Referrals", url: "/marketing/referrals", icon: Share2Icon, featureKey: "referrals" },
    ],
  },
  {
    label: "Reputation",
    items: [
      { title: "Reviews", url: "/reputation/reviews", icon: StarIcon, featureKey: "reviews" },
      { title: "Testimonials", url: "/reputation/testimonials", icon: MessageSquareIcon, featureKey: "testimonials" },
      { title: "Customer Gallery", url: "/reputation/gallery", icon: ImageIcon, featureKey: "gallery" },
    ],
  },
  {
    label: "Website",
    items: [
      { title: "Services", url: "/website/services", icon: WrenchIcon, featureKey: "services" },
      { title: "Products", url: "/website/products", icon: PackageIcon, featureKey: "products" },
      { title: "Pages", url: "/website/pages", icon: FileTextIcon, featureKey: "pages" },
      { title: "FAQs", url: "/website/faqs", icon: HelpCircleIcon, featureKey: "faqs" },
      { title: "Media", url: "/website/media", icon: FileImageIcon, featureKey: "media" },
      { title: "SEO", url: "/website/seo", icon: SearchIcon, featureKey: "seo" },
    ],
  },
  {
    label: "Analytics",
    items: [
      { title: "Analytics", url: "/analytics", icon: BarChartIcon, featureKey: "analytics", exact: true },
      { title: "Traffic Sources", url: "/analytics/traffic-sources", icon: TrendingUpIcon, featureKey: "trafficSources" },
      { title: "Reports", url: "/analytics/reports", icon: FileBarChartIcon, featureKey: "reports" },
    ],
  },
  {
    label: "Business",
    items: [
      { title: "Business Profile", url: "/business/profile", icon: BuildingIcon, featureKey: "businessProfile" },
      { title: "Service Areas", url: "/business/service-areas", icon: MapPinIcon, featureKey: "serviceAreas" },
      { title: "Business Hours", url: "/business/hours", icon: ClockIcon, featureKey: "businessHours" },
    ],
  },
  {
    label: "Team",
    items: [
      { title: "Staff", url: "/team/staff", icon: Users2Icon, featureKey: "staff" },
      { title: "Roles & Permissions", url: "/team/roles", icon: ShieldIcon, featureKey: "roles" },
    ],
  },
  {
    label: "System",
